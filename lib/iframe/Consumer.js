...
var IFrameResizer = function () {
  ...
  (0, _createClass3.default)(IFrameResizer, [{
    ...
    value: function watchSize() {
      ...
      var resize = (0, _throttle2.default)(function () {
        console.log('resize', Date.now()); // eslint-disable-line no-console
        _this.resize();
      }, 60, {
        leading: true,
        trailing: true
      });
      _DOM.mutationEvents.on('mutation', resize);
    }
  }]);
...
var IFrameConsumer = function () {
  ...
  function IFrameConsumer(config) {
    ...
    (0, _forOwn2.default)(properties, function (value, key) {
      _this2.properties[key] = (0, _isFunction2.default)(value) ? value.bind(_this2) : value;
      if ((0, _isUndefined2.default)(_this2[key])) _this2[key] = _this2.properties[key];
    });
    ...
    this.transport.once('ready', function () {
      _this2.provider = _this2.transport.provider;
      _this2.parentUrl = _this2.provider.url;

      var _parseUrl = (0, _url.parse)(_this2.parentUrl),
          protocol = _parseUrl.protocol,
          host = _parseUrl.host;

      _this2.parentOrigin = protocol + '//' + host;
    });
  }
    ...
    value: function externalizeAsConsumer() {
      ...
      return (0, _extends3.default)({}, this.config.externalizeAsConsumer ? this.config.externalizeAsConsumer.call(this) : this.properties, {
        ...
        initialize: function initialize() {
          return _this3.config.initialize.call(_this3, _this3.provider);
        },
        externalizedProps: this.externalize(),
        getSize: function getSize() {
          return _this3.resizer.getSize();
        },
        watchSize: function watchSize() {
          return _this3.resizer.watchSize();
        },
        resize: function resize(params) {
          _this3.resizer.resize(params);
        }
      });
    }
