...
var EmbedLayout = (_class = function (_BaseLayout) {
  ...
  function EmbedLayout() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (EmbedLayout.__proto__ || (0, _getPrototypeOf2.default)(EmbedLayout)).call(this, config));
    ...
    (0, _DOM.setClass)(_this.element, _EmbedLayout2.default.EmbedLayout, _EmbedLayout2.default['is-hidden']);
    return _this;
  }
  ...
  (0, _createClass3.default)(EmbedLayout, [{
    ...
    key: 'hide',
    value: function hide() {
      (0, _DOM.toggleClass)(this.element, _EmbedLayout2.default['is-hidden'], true);
    }
    ...
    key: 'show',
    value: function show() {
      (0, _DOM.toggleClass)(this.element, _EmbedLayout2.default['is-hidden'], false);
    }
  ...
  return EmbedLayout;
}(_BaseLayout3.default), (_applyDecoratedDescriptor(_class.prototype, 'destroy', [_coreDecorators.autobind, _decorators.once], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'destroy'), _class.prototype)), _class);
