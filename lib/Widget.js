...
var Widget = (_dec = (0, _coreDecorators.mixin)(_EventEmitter2.default.prototype), _dec(_class = (_class2 = function () {
  ...
  function Widget(mediator, id, config, properties, params) {
    ...
    (0, _lodash.forOwn)(properties, function (value, key) {
      ...
      if ((0, _lodash.isUndefined)(_this[key])) _this[key] = _this.properties[key];
    });
  }
  ...
  (0, _createClass3.default)(Widget, [{
    ...
    key: '_iFrameScrollTo',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(top, duration) {
  ...
  return Widget;
}(), (_applyDecoratedDescriptor(_class2.prototype, 'destroy', [_coreDecorators.autobind, _decorators.once], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'destroy'), _class2.prototype)), _class2)) || _class);
